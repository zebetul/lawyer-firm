...
export default function About({ data }) {
	...
	return (
		<Layout>
			<h1 className="services-title mx-auto mb-20 md:mb-32 mt-20 border-b-2 pb-2 border-accent px-5 text-center text-xl md:text-4xl text-secondary font-serif">
				DESPRE
			</h1>

			<div className="about-container mb-32 px-5 flex flex-col-reverse md:flex-row gap-20 text-secondary">
